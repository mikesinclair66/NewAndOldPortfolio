                            ...
                            <div className="ch-container">
                                ...
                                <div className={`collapse-hidden${collapseActive == 1 ? '-joking' : ''}`}>
                                    <p>My programming languages for mobile are Swift and C++ using xCode. My most common
                                        ...
                                        down to the last pixel with GL libraries because I want my projects to be designed
                                        in spectacular fashion. However, I&#39;m aware that this is not always conducive to fast-paced
